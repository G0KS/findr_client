            ...
            <div className="fw-bolder d-flex mt-2">
              ...
              <div className="ms-5">
                <input
                  ...
                  name="tenth_mode_of_study"
                  checked={
                    updatedData.tenth_mode_of_study === 'Distance / Online'
                  }
            ...
            <div className="fw-bolder d-flex mt-2">
              <div className="">
                <input
                  ...
                  onChange={(e) => getFormData(e)}
                />
                <label className="ps-2 cursor" htmlFor="twelfthPursuingY">
                  Yes
                </label>
              </div>
              ...
              <div className="ms-5">
                <input
                  ...
                  onChange={(e) => getFormData(e)}
                />
                <label className="ps-2 cursor" htmlFor="twelfthPursuingN">
                  No
                </label>
              </div>
            </div>
          ...
          <div className="row p-4 d-flex">
              ...
              <div className="fw-bolder d-flex mt-2">
                <div className="">
                  <input
                    ...
                    value="1"
                    checked={additionalCourse.currently_studying === '1'}
                    onChange={(e) => getAdditionalCourse(e)}
                  />
                  <label className="ps-2 cursor" htmlFor="additionalPursuingY">
                    Yes
                  </label>
                </div>
                ...
                <div className="ms-5">
                  <input
                    ...
                    name="currently_studying"
                    value="0"
                    checked={additionalCourse.currently_studying === '0'}
                    onChange={(e) => getAdditionalCourse(e)}
                  />
                  <label className="ps-2 cursor" htmlFor="additionalPursuingN">
                    No
                  </label>
                </div>
              </div>
              ...
              <div className="fw-bolder d-flex mt-2">
                <div className="">
                  <input
                    ...
                    name="mode_of_study"
                    checked={additionalCourse.mode_of_study === 'Full Time'}
                    value="Full Time"
                    onChange={(e) => getAdditionalCourse(e)}
                  />
                  <label className="ps-2 cursor" htmlFor="additionalFulltime">
                    Full time
                  </label>
                </div>
                ...
                <div className="ms-5">
                  <input
                    ...
                    name="mode_of_study"
                    checked={additionalCourse.mode_of_study === 'Part Time'}
                    value="Part Time"
                    onChange={(e) => getAdditionalCourse(e)}
                  />
                  <label className="ps-2 cursor" htmlFor="additionalParttime">
                    Part time
                  </label>
                </div>
                <div className="ms-5">
                  <input
                    ...
                    name="mode_of_study"
                    checked={
                      additionalCourse.mode_of_study === 'Distance / Online'
                    }
                    value="Distance / Online"
                    onChange={(e) => getAdditionalCourse(e)}
                  />
                  <label className="ps-2 cursor" htmlFor="additionalDistance">
                    Distance
                  </label>
                </div>
              </div>
            ...
            {updatedData.additional_course.length > 0 && (
              <div className="d-flex flex-wrap gap-4 px-4 py-5">
                {updatedData.additional_course.map((addedCourse, index) => (
                  <div className="d-flex gap-4 addFormCard" key={index}>
                    <div className="shadow rounded p-3 w-100">
                      ...
                      <p className="mb-0">{addedCourse.level_of_study}</p>
                    </div>
