            ...
            <div className="cardContainer my-3 mx-5 mx-lg-1 d-flex justify-content-between align-items-center flex-wrap row-gap-3 ">
               ...
               >
                  ...
                  <p style={{ fontSize: "15px" }}>
                     We believe that each student is unique, and their
                     educational journey should reflect their individual
                     aspirations and goals. Our consultation services are
                     personalized to suit your specific needs, ensuring that you
                     receive guidance tailored to your academic interests,
               ...
               >
                  ...
                  <p style={{ fontSize: "15px" }}>
                     ...
                     all. That&#39;s why we offer our consultation services at a
                     competitive price of INR 7499
                     <span className="fw-bold">*</span>. Additionally, for those
                     seeking scholarship opportunities, we provide specialized
                     guidance at an affordable rate of INR 2499.
                  </p>
               </div>
               <div
                  className="cardBody border p-4 shadow"
               ...
               >
                  ...
                  <p style={{ fontSize: "15px" }}>
                     We don&#39;t do admissions or visa services in Findr. We
                     just pick the best courses for you. We provide a
                     comprehensive range of courses from universities around the
                     globe, without any specific preference for country or
                     institution. Our goal is to help you find the best
                     educational opportunities based on your needs and
                     interests.
                  </p>
               </div>
               <div
               ...
               >
                  ...
                  <p style={{ fontSize: "15px" }}>
                     ...
                     academic pursuits. Whether you dream of studying
                     engineering in Germany, business in the United States, or
                     literature in the United Kingdom, we have the expertise to
                     match you with the perfect program.
                  </p>
               </div>
            </div>
         </section>
