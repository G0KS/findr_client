      ...
      <section className=" container flex items-center justify-center py-20 shadow rounded  mt-5">
        <div className="rounded w-full p-5 ">
          ...
          <div className="p-7 pt-0 lg:p-10 lg:pt-0 prose-sm max-w-none lg:prose lg:max-w-none">
            ...
            <p>
              <strong>findr.study</strong> believes in helping its customers as
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>findr.study</strong> does not accept cancellation
              ...
              <li>
                <p>
                  ...
                  notice of our customer service within same day of receiving
              ...
              <li>
                <p>
                  ...
                  <strong>findr.study</strong>, it’ll take 6-8 days for the
