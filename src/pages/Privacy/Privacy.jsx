      ...
      <div className="container d-flex justify-content-start shadow rounded" style={{marginTrim:"500px"}}>
        <div className="p-4 ">
          ...
          <ol>
            ...
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">Country </span>refers to: Kerala, India
            </ul>
            <ul className="mt-4" style={{ display: 'list-item' }}>
            ...
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">Personal Data</span> is any information
            ...
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">Website</span> refers to Findr.study,
              accessible from https://findr.study
            </ul>
            <ul className="mt-4" style={{ display: 'list-item' }}>
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">Cookies or Browser Cookies.</span> A
            ...
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">Web Beacons..</span> Certain sections of
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">Necessary / Essential Cookies</span>
            </ul>
            <ul className="mt-4" style={{ display: 'list-item' }}>
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">To provide You :</span> with news,
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">To manage Your requests:</span> To
              attend and manage Your requests to Us.
            </ul>
          </ol>
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">For business transfers:</span> We may
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">For other purposes:</span> We may use
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">With Service Providers:</span> We may
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">With Affiliates:</span> We may share
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">With business partners:</span> We may
          ...
          <ol>
            <ul className="mt-4" style={{ display: 'list-item' }}>
              <span className="fw-bold">With other users:</span> when You share
          ...
          <h5 className="mt-4 fw-bold">Disclosure of Your Personal Data</h5>
