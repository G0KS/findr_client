                            ...
                            <div className="p-3">
                              <div>
                                <p
                                  ...
                                  style={{ color: '#0F6990', fontSize: '18px' }}
                                >
                                  {course.course_name.toUpperCase()}
                                </p>
                              </div>
                          ...
                          <div className="d-flex flex-column align-items-center w-100">
                            <div className="">
                              <p
                                ...
                                style={{ fontSize: '25px' }}
                              >
                                Exciting News! Your course list has been
                                updated.
                              </p>
                            </div>
                          </div>
                        ...
                        {consultancyChoosed ? (
                          <div className="courseDetailCard shadow">
                            ...
                            >
                              ...
                              >
                                {' '}
                                We have accepted your request and our team will
                              ...
                              <>
                                ...
                                <div className="courseDetailCard shadow">
                                  ...
                                  >
                                    ...
                                    >
                                      {' '}
                                      Give Your Preferrd Consultancy Details
                                    </h5>
                                    <div className="d-flex flex-wrap px-5 py-5 pb-4 pt-3 ">
                                      <label
                                        htmlFor=""
                      ...
                      <div className="d-flex flex-column align-items-center">
                        ...
                        <div className="">
                          <p
                            ...
                            style={{ fontSize: '22px' }}
                          >
                            Our expert analysis team is currently examining your
                            data in depth to identify the most fitting course
                            designed specifically for your educational and
                            career goals.
                          </p>
                        </div>
                      </div>
