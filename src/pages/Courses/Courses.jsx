            ...
            {data.course_list?.map((course) => (
              <div className="courseCard shadow" key={course.name}>
                ...
                <div className="p-3">
                  ...
                  <div className="p-3">
                    <p>
                      <span className="fw-bolder" style={{ color: '#0f6990' }}>
                        University :
                      </span>{' '}
                      {course.university}
                    </p>
            ...
            {data?.registration_fee === 1 ? (
              data.course_list?.length > 0 ? (
                <>
                  ...
                  <div className="paymentCard shadow">
                    
                    <div className="paymentImgContainer p-3">
                      <img className="paymentImg" src={paymemtImg2} alt="" />
                    </div>
                    <h5
                    ...
                    <div className="pb-3 d-flex justify-content-center ">
                      <button className="btnNew btn2 w-50 text-center">
                        Click here
                      </button>
                    </div>
                  </div>
                   <div className="paymentCard shadow">
                    <div className="paymentImgContainer p-3">
                      <img className="paymentImg" src={paymemtImg} alt="" />
                    </div>
                    <h5
                      className="text-center pt-4 px-4 fw-bolder"
                      style={{ color: '#0F6990' }}
                  ...
                  <div className="paymentCard shadow">
                    <div className="paymentImgContainer p-3">
                      <img className="paymentImg" src={Consultant} alt="" />
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        {' '}
                        Let Findr Choose Best Consultant For You
                      </h5>
                      <div className="checkList">
                        <ul className="ms-3 mt-4" style={{ listStyle: 'none' }}>
                          <li className="fw-bolder">
                            <img className="checkImg me-2" src={tick} alt="" />
                    ...
                    <div className="pb-3 d-flex justify-content-center ">
                      <button className="btnNew btn2 w-25 text-center">
                        Submit
                      </button>
                    </div>
                  </div>
                  <div className="paymentCard shadow">
                    <div className="paymentImgContainer p-3">
                      <img className="paymentImg" src={Consultantown} alt="" />
                    </div>
                    <div
                      className="paymentCardContent "
                      style={{ height: '340px' }}
                    >
                      ...
                      >
                        {' '}
                        Give Your Prefferd Consultancy Details
                      </h5>
                      <div className="d-flex flex-wrap px-5 py-5 pb-4 pt-3 ">
                        <label htmlFor="" className="d-block fw-bolder mb-2">
                          {' '}
                        ...
                        <input className="profileInputBox" type="number" />
                      </div>
                    </div>
                    <div className="pb-3 d-flex justify-content-center ">
                      <button className="btnNew btn2 w-25 text-center">
